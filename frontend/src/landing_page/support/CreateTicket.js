...
function CreateTicket() {
  return (
    ...
    <div className="row p-5  mb-5">
      ...
      <div className="col-4  p-5 text-muted">
        <h4>
          <i class="fa fa-sellsy" aria-hidden="true"></i>Kite
        </h4>
        <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>
          IPO
        </a>
      ...
      <div className="col-4  mb-5 p-5 text-muted">
        {" "}
        <h4>
      ...
      <div className="col-4  mb-5 p-5 text-muted">
        {" "}
        <h4>
          <i class="fa fa-user-o" aria-hidden="true"></i> Console
        </h4>
        <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>
          Portfolio
        </a>
      ...
      <div className="col-4  mb-5 p-5 text-muted">
        <h4>
          <i class="fa fa-sellsy" aria-hidden="true"></i> Coin
        </h4>
        <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>
